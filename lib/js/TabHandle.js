...
export class TabHandle {
    ...
    generateMoveTabEvent(event, pos) {
        ...
        console.log(event.state, "m: " + m, "threshold: " + this.moveThreshold, "contain: " + contain, "left: " + event.rect.left, "right: " + event.rect.right, "pos: " + pos, "bound: " + event.bound, "movethers: ");
        if (m < this.moveThreshold && contain) {
            console.log("YJKGKLDJGKLJGLKG");
