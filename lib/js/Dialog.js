...
export class Dialog {
    ...
    _initialize() {
        ...
        const resizeDirection = this.disableResize
    ...
    createContextMenuItems() {
        return Dialog.createContextMenuContentCallback(this, this.dockManager.context.model.documentManagerNode.children);
    }
}
