...
export class DockManager {
    ...
    floatDialog(container, x, y, grayoutParent, resizeDirection) {
    ...
    */
     ...
     * It is assumed that only leaf nodes (panels) can be undocked
     */
    openInDialog(container, event, dragOffset, resizeDirection) {
        // Create a new dialog window for the undocked panel
    ...
    async notifyOnActiveDocumentChange(panel, oldActive) {
